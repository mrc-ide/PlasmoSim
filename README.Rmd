...
PlasmoSim is an R package for simulating both epidemiological and genetic data from a simple model of *Plasmodium falciparum* transmission. The model itself is fairly lightweight, which speeds up computation times and allows us to model multiple demes (partially isolated sub-populations) connected by migration.
